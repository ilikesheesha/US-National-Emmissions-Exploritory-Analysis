# Script to show whether total emissions from PM2.5 have decreased in the Baltimore City, Maryland (fips == "24510") 
# from 1999 to 2008.
# The base plotting system was used to answer this question and create plot2.png.
#
# OUtline:
